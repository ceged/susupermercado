 ...
 */
@Entity
public class RetraitMagasin implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RetraitMagasin)) {
            return false;
        }
        RetraitMagasin other = (RetraitMagasin) object;
    ...
    public String toString() {
        return "entit\u00e9s.gestionMagasin.RetraitMagasin[ id=" + id + " ]";
    }
